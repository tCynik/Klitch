...
import ru.tcynik.meshtactics.mesh.model.util.formatUptime
import ru.tcynik.meshtactics.mesh.navigation.DEEP_LINK_BASE_URI
import ru.tcynik.meshtactics.mesh.common.BuildConfigProvider
import ru.tcynik.meshtactics.mesh.repository.MeshServiceNotifications
import ru.tcynik.meshtactics.mesh.repository.NodeRepository
import ru.tcynik.meshtactics.mesh.repository.PacketRepository
import ru.tcynik.meshtactics.mesh.repository.SERVICE_NOTIFY_ID
...
import ru.tcynik.meshtactics.mesh.resources.connected
import ru.tcynik.meshtactics.mesh.resources.connecting
import ru.tcynik.meshtactics.mesh.resources.device_sleeping
import ru.tcynik.meshtactics.mesh.resources.disconnected
import ru.tcynik.meshtactics.mesh.resources.getString
import ru.tcynik.meshtactics.mesh.resources.local_stats_bad
import ru.tcynik.meshtactics.mesh.resources.local_stats_battery
import ru.tcynik.meshtactics.mesh.resources.local_stats_diagnostics_prefix
import ru.tcynik.meshtactics.mesh.resources.local_stats_dropped
import ru.tcynik.meshtactics.mesh.resources.local_stats_heap
import ru.tcynik.meshtactics.mesh.resources.local_stats_heap_value
import ru.tcynik.meshtactics.mesh.resources.local_stats_nodes
import ru.tcynik.meshtactics.mesh.resources.local_stats_noise
import ru.tcynik.meshtactics.mesh.resources.local_stats_relays
import ru.tcynik.meshtactics.mesh.resources.local_stats_traffic
import ru.tcynik.meshtactics.mesh.resources.local_stats_uptime
import ru.tcynik.meshtactics.mesh.resources.local_stats_utilization
import ru.tcynik.meshtactics.mesh.resources.low_battery_message
import ru.tcynik.meshtactics.mesh.resources.low_battery_title
import ru.tcynik.meshtactics.mesh.resources.mark_as_read
import ru.tcynik.meshtactics.mesh.resources.meshtastic_alerts_notifications
import ru.tcynik.meshtactics.mesh.resources.meshtastic_app_name
import ru.tcynik.meshtactics.mesh.resources.meshtastic_broadcast_notifications
import ru.tcynik.meshtactics.mesh.resources.meshtastic_low_battery_notifications
import ru.tcynik.meshtactics.mesh.resources.meshtastic_low_battery_temporary_remote_notifications
import ru.tcynik.meshtactics.mesh.resources.meshtastic_messages_notifications
import ru.tcynik.meshtactics.mesh.resources.meshtastic_new_nodes_notifications
import ru.tcynik.meshtactics.mesh.resources.meshtastic_service_notifications
import ru.tcynik.meshtactics.mesh.resources.meshtastic_waypoints_notifications
import ru.tcynik.meshtactics.mesh.resources.new_node_seen
import ru.tcynik.meshtactics.mesh.resources.no_local_stats
import ru.tcynik.meshtactics.mesh.resources.powered
import ru.tcynik.meshtactics.mesh.resources.reply
import ru.tcynik.meshtactics.mesh.resources.you
import ru.tcynik.meshtactics.mesh.service.MarkAsReadReceiver.Companion.MARK_AS_READ_ACTION
import ru.tcynik.meshtactics.mesh.service.ReactionReceiver.Companion.REACT_ACTION
import ru.tcynik.meshtactics.mesh.service.ReplyReceiver.Companion.KEY_TEXT_REPLY
            ...
            NotificationChannel(type.channelId, channelName, type.importance).apply {
                ...
                when (type) {
                    ...
                    NotificationType.Alert -> {
                        ...
                        setBypassDnd(true)
                        val alertSoundUri = "${SCHEME_ANDROID_RESOURCE}://${context.packageName}/${R.raw.alert}".toUri()
                        setSound(
                            alertSoundUri,
                            AudioAttributes.Builder()
