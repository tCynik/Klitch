...
object DateFormatter {
    fun formatRelativeTime(timestampMillis: Long): String = DateUtils.getRelativeTimeSpanString(
        timestampMillis,
        nowMillis,
    ...
    fun formatDateTime(timestampMillis: Long): String = DateUtils.formatDateTime(
        ContextServices.app,
        timestampMillis,
