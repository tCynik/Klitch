...
import ru.tcynik.mymesh1.mesh.database.DatabaseProvider
import ru.tcynik.mymesh1.mesh.database.dao.PacketDao
import ru.tcynik.mymesh1.mesh.database.entity.toReaction
import ru.tcynik.mymesh1.mesh.di.CoroutineDispatchers
import ru.tcynik.mymesh1.mesh.model.ContactSettings
...
import ru.tcynik.mymesh1.mesh.database.entity.ContactSettings as ContactSettingsEntity
import ru.tcynik.mymesh1.mesh.database.entity.Packet as RoomPacket
import ru.tcynik.mymesh1.mesh.database.entity.ReactionEntity as RoomReaction
import ru.tcynik.mymesh1.mesh.repository.PacketRepository as SharedPacketRepository
...
class PacketRepositoryImpl(private val dbManager: DatabaseProvider, private val dispatchers: CoroutineDispatchers) :
    ...
    private fun PacketDao.getAllWaypointsFlow(): Flow<List<RoomPacket>> =
