 ...
 */
package ru.tcynik.mymesh1.mesh.service
...
import ru.tcynik.mymesh1.mesh.repository.SERVICE_NOTIFY_ID
import ru.tcynik.mymesh1.mesh.R
import ru.tcynik.mymesh1.mesh.resources.Res
import ru.tcynik.mymesh1.mesh.resources.client_notification
import ru.tcynik.mymesh1.mesh.resources.connected
import ru.tcynik.mymesh1.mesh.resources.connecting
import ru.tcynik.mymesh1.mesh.resources.device_sleeping
import ru.tcynik.mymesh1.mesh.resources.disconnected
import ru.tcynik.mymesh1.mesh.resources.getString
import ru.tcynik.mymesh1.mesh.resources.local_stats_bad
import ru.tcynik.mymesh1.mesh.resources.local_stats_battery
import ru.tcynik.mymesh1.mesh.resources.local_stats_diagnostics_prefix
import ru.tcynik.mymesh1.mesh.resources.local_stats_dropped
import ru.tcynik.mymesh1.mesh.resources.local_stats_heap
import ru.tcynik.mymesh1.mesh.resources.local_stats_heap_value
import ru.tcynik.mymesh1.mesh.resources.local_stats_nodes
import ru.tcynik.mymesh1.mesh.resources.local_stats_noise
import ru.tcynik.mymesh1.mesh.resources.local_stats_relays
import ru.tcynik.mymesh1.mesh.resources.local_stats_traffic
import ru.tcynik.mymesh1.mesh.resources.local_stats_uptime
import ru.tcynik.mymesh1.mesh.resources.local_stats_utilization
import ru.tcynik.mymesh1.mesh.resources.low_battery_message
import ru.tcynik.mymesh1.mesh.resources.low_battery_title
import ru.tcynik.mymesh1.mesh.resources.mark_as_read
import ru.tcynik.mymesh1.mesh.resources.meshtastic_alerts_notifications
import ru.tcynik.mymesh1.mesh.resources.meshtastic_app_name
import ru.tcynik.mymesh1.mesh.resources.meshtastic_broadcast_notifications
import ru.tcynik.mymesh1.mesh.resources.meshtastic_low_battery_notifications
import ru.tcynik.mymesh1.mesh.resources.meshtastic_low_battery_temporary_remote_notifications
import ru.tcynik.mymesh1.mesh.resources.meshtastic_messages_notifications
import ru.tcynik.mymesh1.mesh.resources.meshtastic_new_nodes_notifications
import ru.tcynik.mymesh1.mesh.resources.meshtastic_service_notifications
import ru.tcynik.mymesh1.mesh.resources.meshtastic_waypoints_notifications
import ru.tcynik.mymesh1.mesh.resources.new_node_seen
import ru.tcynik.mymesh1.mesh.resources.no_local_stats
import ru.tcynik.mymesh1.mesh.resources.powered
import ru.tcynik.mymesh1.mesh.resources.reply
import ru.tcynik.mymesh1.mesh.resources.you
import ru.tcynik.mymesh1.mesh.service.MarkAsReadReceiver.Companion.MARK_AS_READ_ACTION
import ru.tcynik.mymesh1.mesh.service.ReactionReceiver.Companion.REACT_ACTION
import ru.tcynik.mymesh1.mesh.service.ReplyReceiver.Companion.KEY_TEXT_REPLY
