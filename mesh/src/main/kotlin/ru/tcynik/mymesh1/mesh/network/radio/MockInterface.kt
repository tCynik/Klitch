...
import ru.tcynik.mymesh1.mesh.model.Channel
import ru.tcynik.mymesh1.mesh.model.DataPacket
import ru.tcynik.mymesh1.mesh.model.Position
import ru.tcynik.mymesh1.mesh.model.util.getInitials
    ...
    private fun makePosition(numIn: Int) = FromRadio(
        ...
        MeshPacket(
            ...
            Data(
                ...
                payload =
                ProtoPosition(
                    latitude_i = Position.degI(32.776665),
                    longitude_i = Position.degI(-96.796989),
                    altitude = 150,
    ...
    private fun sendConfigResponse(configId: Int) {
        ...
        fun makeNodeInfo(numIn: Int, lat: Double, lon: Double) = FromRadio(
            ...
            NodeInfo(
                ...
                position =
                ProtoPosition(
                    latitude_i = Position.degI(lat),
                    longitude_i = Position.degI(lon),
                    altitude = 35,
                    time = nowSeconds.toInt(),
