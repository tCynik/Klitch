...
import ru.tcynik.mymesh1.mesh.ble.BleConnection
import ru.tcynik.mymesh1.mesh.ble.BleConnectionFactory
import ru.tcynik.mymesh1.mesh.ble.BleConnectionState
import ru.tcynik.mymesh1.mesh.ble.BleDevice
import ru.tcynik.mymesh1.mesh.ble.BleScanner
import ru.tcynik.mymesh1.mesh.ble.BleWriteType
import ru.tcynik.mymesh1.mesh.ble.BluetoothRepository
import ru.tcynik.mymesh1.mesh.ble.MeshtasticBleConstants.SERVICE_UUID
import ru.tcynik.mymesh1.mesh.ble.MeshtasticRadioProfile
import ru.tcynik.mymesh1.mesh.ble.retryBleOperation
import ru.tcynik.mymesh1.mesh.ble.toMeshtasticRadioProfile
import ru.tcynik.mymesh1.mesh.common.util.nowMillis
import ru.tcynik.mymesh1.mesh.model.RadioNotConnectedException
import ru.tcynik.mymesh1.mesh.repository.RadioInterfaceService
import ru.tcynik.mymesh1.mesh.repository.RadioTransport
...
class BleRadioInterface(
    ...
    private var radioService: MeshtasticRadioProfile? = null
