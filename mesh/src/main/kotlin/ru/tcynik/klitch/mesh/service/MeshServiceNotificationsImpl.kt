...
import ru.tcynik.klitch.mesh.resources.StringResource
...
import ru.tcynik.klitch.mesh.model.util.formatUptime
import ru.tcynik.klitch.mesh.navigation.DEEP_LINK_BASE_URI
...
import ru.tcynik.klitch.mesh.resources.connected
import ru.tcynik.klitch.mesh.resources.connecting
import ru.tcynik.klitch.mesh.resources.device_sleeping
import ru.tcynik.klitch.mesh.resources.disconnected
import ru.tcynik.klitch.mesh.resources.getString
import ru.tcynik.klitch.mesh.resources.local_stats_bad
import ru.tcynik.klitch.mesh.resources.local_stats_battery
import ru.tcynik.klitch.mesh.resources.local_stats_diagnostics_prefix
import ru.tcynik.klitch.mesh.resources.local_stats_dropped
import ru.tcynik.klitch.mesh.resources.local_stats_heap
import ru.tcynik.klitch.mesh.resources.local_stats_heap_value
import ru.tcynik.klitch.mesh.resources.local_stats_nodes
import ru.tcynik.klitch.mesh.resources.local_stats_noise
import ru.tcynik.klitch.mesh.resources.local_stats_relays
import ru.tcynik.klitch.mesh.resources.local_stats_traffic
import ru.tcynik.klitch.mesh.resources.local_stats_uptime
import ru.tcynik.klitch.mesh.resources.local_stats_utilization
import ru.tcynik.klitch.mesh.resources.low_battery_message
import ru.tcynik.klitch.mesh.resources.low_battery_title
import ru.tcynik.klitch.mesh.resources.mark_as_read
import ru.tcynik.klitch.mesh.resources.meshtastic_alerts_notifications
import ru.tcynik.klitch.mesh.resources.meshtastic_app_name
import ru.tcynik.klitch.mesh.resources.meshtastic_broadcast_notifications
import ru.tcynik.klitch.mesh.resources.meshtastic_low_battery_notifications
import ru.tcynik.klitch.mesh.resources.meshtastic_low_battery_temporary_remote_notifications
...
import ru.tcynik.klitch.mesh.resources.meshtastic_waypoints_notifications
import ru.tcynik.klitch.mesh.resources.new_node_seen
import ru.tcynik.klitch.mesh.resources.no_local_stats
import ru.tcynik.klitch.mesh.resources.powered
import ru.tcynik.klitch.mesh.resources.reply
import ru.tcynik.klitch.mesh.resources.you
import ru.tcynik.klitch.mesh.service.MarkAsReadReceiver.Companion.MARK_AS_READ_ACTION
import ru.tcynik.klitch.mesh.service.ReactionReceiver.Companion.REACT_ACTION
import ru.tcynik.klitch.mesh.service.ReplyReceiver.Companion.KEY_TEXT_REPLY
