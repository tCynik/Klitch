...
import ru.tcynik.klitch.mesh.data.datasource.BootloaderOtaQuirksJsonDataSource
import ru.tcynik.klitch.mesh.data.datasource.DeviceHardwareJsonDataSource
import ru.tcynik.klitch.mesh.data.datasource.DeviceHardwareLocalDataSource
import ru.tcynik.klitch.mesh.database.entity.DeviceHardwareEntity
import ru.tcynik.klitch.mesh.database.entity.asExternalModel
import ru.tcynik.klitch.mesh.di.CoroutineDispatchers
import ru.tcynik.klitch.mesh.model.BootloaderOtaQuirk
import ru.tcynik.klitch.mesh.model.DeviceHardware
import ru.tcynik.klitch.mesh.model.util.TimeConstants
import ru.tcynik.klitch.mesh.network.DeviceHardwareRemoteDataSource
import ru.tcynik.klitch.mesh.repository.DeviceHardwareRepository
