...
import ru.tcynik.klitch.presentation.feature.main.osd.models.MarkerSizeConfig
...
import androidx.compose.runtime.setValue
import ru.tcynik.klitch.presentation.feature.main.MarkToolTapDispatcher
import ru.tcynik.klitch.presentation.feature.main.markToolMapTapGestures
...
fun MapLibreLayer(
    ...
    pendingMarkPoints: ImmutableList<ru.tcynik.klitch.domain.marker.model.GeoPoint> = persistentListOf(),
            ...
            val interpolated = target.map { targetNode ->
                ...
                if (prev != null) {
                    ...
                    if (startLon != endLon || startLat != endLat) {
                        ...
                        targetNode.copy(
                            position = ru.tcynik.klitch.domain.marker.model.GeoPoint(interpLat, interpLon),
                        )
                    } else {
                        targetNode
                    }
...
private fun buildDraftPointsGeoJson(
    points: List<ru.tcynik.klitch.domain.marker.model.GeoPoint>,
): String {
...
private fun buildPointGeoJson(
    point: ru.tcynik.klitch.domain.marker.model.GeoPoint,
): String =
...
private fun bearingDegrees(
    from: ru.tcynik.klitch.domain.marker.model.GeoPoint,
    to: ru.tcynik.klitch.domain.marker.model.GeoPoint,
): Double {
