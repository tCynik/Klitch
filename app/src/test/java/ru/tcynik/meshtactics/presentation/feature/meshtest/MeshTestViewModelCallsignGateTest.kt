...
class MeshTestViewModelCallsignGateTest {
    ...
    private val observeMessages: ObserveMessagesUseCase = mockk()
    private val sendMessage: SendMeshMessageUseCase = mockk(relaxed = true)
    private val observeGeoNodes: ObserveGeoNodesUseCase = mockk()
    ...
    private lateinit var viewModel: MeshTestViewModel
    ...
    fun setUp() {
        ...
        every { observeMessages.invoke(any()) } returns flowOf(emptyList())
        every { observeGeoNodes.invoke(any()) } returns flowOf(emptyList())
    ...
    private fun createViewModel() {
        viewModel = MeshTestViewModel(
            ...
            observeGeoNodes = observeGeoNodes,
